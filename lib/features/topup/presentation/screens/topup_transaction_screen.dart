...
class TopUpTransactionScreen extends StatefulWidget {
  ...
  const TopUpTransactionScreen({super.key, required this.beneficiary, required this.user});
      ...
      listener: (context, state) {
        ...
        if (state.status == TopupStatus.error && state.errorMessage != null) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(state.errorMessage!, style: AppTextStyles.bodyMedium.copyWith(color: ColorPalette.white)),
        ...
        if (state.status == TopupStatus.success && _selectedAmount != null) {
          ...
          showTopUpSuccessBottomSheet(
            ...
            remainingLimitForBeneficiary: TopupEligibility.remainingAfterTopup(widget.user, widget.beneficiary, amount),
          ...
          child: Material(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: const [BoxShadow(color: ColorPalette.overlayMedium, blurRadius: 10, spreadRadius: 1)],
              ),
              child: Column(
